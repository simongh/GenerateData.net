namespace GenerateData.Migrations
{
	...
	internal sealed class Configuration : DbMigrationsConfiguration<GenerateData.Data.Context>
	{
		...
		protected override void Seed(GenerateData.Data.Context context)
		{
			...
			context.Settings.AddOrUpdate(s => s.Name,
				...
				new Data.Setting
				{
					Name = Settings.UserAccountSetup,
					Value = ""
				},
				new Data.Setting
				{
					Name = Settings.ConsoleEventsPublish,
					Value = ""
				},
				new Data.Setting
				{
					Name = Settings.ConsoleEventsSubscribe,
					Value = ""
				},
				new Data.Setting
				{
					Name = Settings.ConsoleEventsDataTypePlugins,
					Value = ""
				},
				new Data.Setting
				{
					Name = Settings.ConsoleEventsExportTypePlugins,
					Value = ""
				},
				new Data.Setting
				{
					Name = Settings.ConsoleCoreEvents,
					Value = ""
				},
				new Data.Setting
				{
					Name = Settings.ConsoleWarnings,
					Value = ""
				},
				new Data.Setting
				{
				...
				new Data.Setting
				{
					Name = Settings.InstallationStepComplete_Core,
					Value = "no"
				},
				new Data.Setting
				{
					Name = Settings.InstallationComplete,
					Value = "no"
				},
				new Data.Setting
				{
					Name = Settings.InstalledDataTypes,
					Value = ""
				},
				new Data.Setting
				{
					Name = Settings.InstalledExportTypes,
					Value = ""
				},
				new Data.Setting
				{
					Name = Settings.InstalledCountries,
					Value = ""
				},
				new Data.Setting
				{
					Name = Settings.AllowAnonymousAccess,
					Value = ""
				},
				new Data.Setting
				{
					Name = Settings.AnonymousUserPermissionDeniedMsg,
					Value = ""
				},
				new Data.Setting
				{
